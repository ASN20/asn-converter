...
export default function MmMetreConverter() {
    ...
    return (
        <>
            <Head>
                <title>ASN Converter - Millimetre / Metre Converter</title>
            </Head>
            <div className="container w-4/5 flex flex-col md:ml-auto mx-auto mt-8 md:mt-0">
                <div id="first-half">
                    <Input value={text1} onChange={handleOnChange1} title="Convert Millimetre to Metre" title2="Type a Millimetre value" unit="m" result={Number(text1) / 1000} />
                ...
                <div id="second-half">
                    <Input value={text2} onChange={handleOnChange2} title="Convert Metre to Millimetre" title2="Type a Metre value" unit="mm" result={Number(text2) * 1000} />
