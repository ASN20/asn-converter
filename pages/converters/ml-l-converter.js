...
export default function MlLitreConverter() {
    ...
    return (
        <>
            <Head>
                <title>ASN Converter - Millilitre / Litre Converter</title>
            </Head>
            <div className="container w-4/5 flex flex-col md:ml-auto mx-auto mt-8 md:mt-0">
                <div id="first-half">
                    <Input value={text1} onChange={handleOnChange1} title="Convert Millilitre to Litre" title2="Type a Millilitre value" unit="l" result={Number(text1) / 1000} />
                ...
                <div id="second-half">
                    <Input value={text2} onChange={handleOnChange2} title="Convert Litre to Millilitre" title2="Type a Litre value" unit="ml" result={Number(text2) * 1000} />
